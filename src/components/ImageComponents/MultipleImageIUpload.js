        ...
        <>
            <form>
                ...
                <div className="container">
                    ...
                    <div className="form-group multi-preview">
                        <div className='row'>
                            {multipleFile.length != 0 && (multipleFile).map((url,index) => (
                                <div key={url} className="col-md-2">
                                    <div className="img-block bg-gray">
                                        <img className='img-fluid2' src={url} alt="..." />
                                        <span className="remove_img" onClick={ ()=> removeImage(index)}> {index} </span>
                                    </div>
                                </div>
                            ))}
                                ...
                                <div className="col-md-2">
                                    <div className="form-group">
                                        <div className="upload-btn-wrapper">
                                            ...
                                            <input type="file" name="myfile" onChange={uploadMultipleFiles} multiple/>
                                        </div>
                                    </div>
                                </div>
                            {/* }                             */}
